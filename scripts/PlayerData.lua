...
local function migrateEquipment(eq)
    ...
    -- 补齐缺失的新槽位
    eq.necklace = eq.necklace or nil
    eq.helmet = eq.helmet or nil
    eq.top_armor = eq.top_armor or nil
    eq.bottom_armor = eq.bottom_armor or nil
    eq.shoes = eq.shoes or nil
    return eq
end
