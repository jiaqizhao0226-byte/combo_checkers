...
BattleData.ENEMY_TEMPLATES = {
    ...
    coral_vine = {
        team = "enemy", enemyType = "coral_vine",
        hp = 20, maxHp = 20,
        atk = 7,
        attackRange = 1,
        attackLabel = "藤刺",
        vineGrowth = true,     -- 每回合往相邻空格生长一块障碍，死亡时所有藤蔓障碍消失
        _vineObstacles = {},   -- 记录自己生长出的障碍格 { {col,row}, ... }
        name = "珊瑚藤蔓",
    },
    splitting_urchin = {
...
BattleData.ENEMY_INTRO = {
    ...
    coral_vine   = { icon = "🌿", name = "珊瑚藤蔓", desc = "每回合往相邻格生长障碍物，死亡时障碍全消失" },
